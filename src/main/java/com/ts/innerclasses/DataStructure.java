package com.ts.innerclasses;

/**
 * The DataStructure outer class, which includes a constructor to create an instance of DataStructure containing an array filled with consecutive integer values (0, 1, 2, 3, and so on) 
 * and a method that prints elements of the array that have an even index value.
 * The EvenIterator inner class, which implements the InnerClassWorkerIterator interface, which extends the Iterator< Integer> interface. 
